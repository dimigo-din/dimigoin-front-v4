...
export const DetsComponent: React.FC<{
  padding: string;
  css?: CSS;
  active?: boolean;
  btnVal: string;
  banner?: any;
}> = ({ padding, css, active, btnVal, banner }) => {
  //방과후 return 값 없음
  ...
  return (
    <Container padding="0" css={css}>
      {banner && <Banner>BannerArea</Banner>}
      <Container padding={padding} css={containerCss}>
        <Header>
          <Title>{title}</Title>
